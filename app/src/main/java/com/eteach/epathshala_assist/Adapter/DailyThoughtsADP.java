...
public class DailyThoughtsADP extends RecyclerView.Adapter<DailyThoughtsADP.MyViewHolder>{
    ...
    public
    DailyThoughtsADP ( FragmentActivity activity, List<File> path, String eventpath) {
