...
public class SyllabusWebservices {
    ...
    public static final String REPORTCARD_WURL_PATH = "get_syllabus.asmx";
    DBHandler dbHandler;
    private Context mContext;

    public
    SyllabusWebservices ( Context context) {
        mContext = context;
    }


    public String GETALLSYLABUS ( int cid, int status ) {
    ...
    private void Addsyllabus ( int cid) {
        dbHandler = new DBHandler(mContext);
        dbHandler.AddSyllabusData (new TBL_SYLLABUS ( cid, WebRespose));
    }
}
