package com.eteach.epathshala_assist.Handler;
...
class NotificationHandler {
    ...
    public void createExpandableNotification (Context context) {
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ...
            String lorem = context.getResources().getString( Integer.parseInt ( "" ) );
    ...
    public void createButtonNotification (Context context) {
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ...
            NotificationCompat.Builder nBuilder = new NotificationCompat.Builder(context)
                    ...
                    .addAction(R.drawable.cancle, "Cancel", pIntent); // cancel notification button
