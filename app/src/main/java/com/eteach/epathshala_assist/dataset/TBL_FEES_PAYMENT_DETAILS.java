...
public class TBL_FEES_PAYMENT_DETAILS {
    String _FeespaymentDATA;
    String _AdmissionNo;
    String _FeesTitle;
    ...
    public TBL_FEES_PAYMENT_DETAILS (String FeesTitle, String FeeCategory, String FeeSubCategory, String Feesperiod, String Feespaymode, String FeestotalAmt, String FeestotalDisc, String FeestotalpaidAmt, String FeestotalBal, String Fees_paid_status, String FeesPaymentDate, String Customer_ID)
    {
    ...
    public TBL_FEES_PAYMENT_DETAILS (String addmissionNo, String FeesDATA)
    {
        _AdmissionNo = addmissionNo;
        _FeespaymentDATA = FeesDATA;
    }

    public TBL_FEES_PAYMENT_DETAILS (int pk_id , String FeesTitle , String FeeCategory,
    ...
    public TBL_FEES_PAYMENT_DETAILS (String FeesTitle ,
                                     String FeeSubCategory,
                                     String Feesperiod ,
                                     String Feespaymode,
                                     String FeestotalAmt,
    ...
    public TBL_FEES_PAYMENT_DETAILS ( ) {
    ...
    public void set_FeespaymentDATA( String feesDATA ) {
        this._FeespaymentDATA = feesDATA;
    }
    ...
    public String get_FeespaymentDATA() {
        return _FeespaymentDATA;
    }
